...
<head>
	...
	<title>Recruitment Management system - Experience</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="../"><img src="../images/lo.png" alt="Logo" /></a>
						</div>
					</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">Recruitment Management system</a></li>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
								    ...
								    <input  value="<?php echo "$start_date"; ?>" class="form-control" placeholder="Eg: 13-01-2021" type="text" name="startdate" required> 
							        </div>
								    ...
								    <input  value="<?php echo "$end_date"; ?>" class="form-control" placeholder="Eg: 01-01-2024" type="text" name="enddate" required> 
							        </div>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Start Date <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Eg: 01 March 2021" type="text" name="startdate" required> 
							        </div>
							        ...
							        <div class="form-group"> 
								    <label>End Date <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Eg: 01 June 2024" type="text" name="enddate" required> 
							        </div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
                                            <h5 class="footer-title">Recruitment Management system</h5>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright   <?php echo date('Y'); ?> Recruitment Management system</p>
